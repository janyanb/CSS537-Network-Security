...
//block ICMP echo from virtual machine(10.9.0.1)
...
//Block Telnet on Virtual Machine(port 23)
...
int registerFilter(void) {
   printk(KERN_INFO "seedDrop:Registering filters.\n");
...
void removeFilter(void) {
   printk(KERN_INFO "seedDrop:The filters are being removed.\n");
